...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("ShokinxOfficial")
                await self.one.join_chat("ShokinxOfficial")                
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("ShokinxOfficial")
                await self.two.join_chat("ShokinxOfficial")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("ShokinxOfficial")
                await self.three.join_chat("ShokinxOfficial")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("ShokinxOfficial")
                await self.four.join_chat("ShokinxOfficial")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("ShokinxOfficial")
                await self.five.join_chat("ShokinxOfficial")
            except:
                pass
            assistants.append(5)
